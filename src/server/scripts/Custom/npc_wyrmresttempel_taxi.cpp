...
class npc_wyrmresttempel_middle_taxi : public CreatureScript
{
public:
    npc_wyrmresttempel_middle_taxi() : CreatureScript("npc_wyrmresttempel_middle_taxi") { }
...
class npc_wyrmresttempel_bottom_taxi : public CreatureScript
{
public:
    npc_wyrmresttempel_bottom_taxi() : CreatureScript("npc_wyrmresttempel_bottom_taxi") { }
...
class npc_wyrmresttempel_top_taxi : public CreatureScript
{
public:
    npc_wyrmresttempel_top_taxi() : CreatureScript("npc_wyrmresttempel_top_taxi") { }
...
{
new npc_wyrmresttempelmiddle_taxi();
new npc_wyrmresttempelbottom_taxi();
new npc_wyrmresttempeltop_taxi();
}
