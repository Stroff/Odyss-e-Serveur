...
#define GOSSIP_AZUREGOS_SPIRIT_PLAYER1 "How did you know? I mean, yes... Yes I am looking for that shard. Do you have it?"
#define GOSSIP_AZUREGOS_SPIRIT_PLAYER2 "Alright. Where?"
#define GOSSIP_AZUREGOS_SPIRIT_PLAYER3 "By Bronzbeard's... um, beard! What are you talking about?"
#define GOSSIP_AZUREGOS_SPIRIT_PLAYER4 "Fish? You gave a piece of what could be the key to saving all life on Kalimdor to a fish?"
#define GOSSIP_AZUREGOS_SPIRIT_PLAYER5 "A minnow? The oceans are filled with minnows! There could be a hundred million minnows out there!"
#define GOSSIP_AZUREGOS_SPIRIT_PLAYER6 "..."
#define GOSSIP_AZUREGOS_SPIRIT_PLAYER7 "You put the piece in a minnow and placed the minnow somewhere in the waters of the sea betwen here and the Eastern Kingdoms? And this minnow has special powers?"
#define GOSSIP_AZUREGOS_SPIRIT_PLAYER8 "You're insane."
#define GOSSIP_AZUREGOS_SPIRIT_PLAYER9 "I'm all ears."
#define GOSSIP_AZUREGOS_SPIRIT_PLAYER10 "Come again."
#define GOSSIP_AZUREGOS_SPIRIT_PLAYER11 "Ok, let me get this straight. You put the scepter shard entrusted to your Flight by Anachronos on a minnow of your own making and now you expect me to build an... an arcanite buoy or something... to force your minnow out of hiding? AND potentially incur the wrath of an Elemental Lord? Did I miss anything? Perhaps I am to do this without any clothes on, during a solar eclipse, on a leap year?"
#define GOSSIP_AZUREGOS_SPIRIT_PLAYER12 "FINE! And how, dare I ask, am I supposed to acquire an arcanite buoy?"
#define GOSSIP_AZUREGOS_SPIRIT_PLAYER13 "But..."

#define ITEM_MAGICAL_LEDGER  20949

class npc_azuregos_spirit : public CreatureScript
{
public:
    npc_azuregos_spirit() : CreatureScript("npc_azuregos_spirit") { }

    CreatureAI* GetAI(Creature* pCreature) const
    {
        return new npc_azuregos_spiritAI (pCreature);
    }

struct npc_azuregos_spiritAI : public ScriptedAI
{
    npc_azuregos_spiritAI(Creature *c) : ScriptedAI(c) {}

bool OnGossipHello(Player* pPlayer, Creature* pCreature)
{
    if (pPlayer->GetQuestStatus(8555) == QUEST_STATUS_COMPLETE)
    {
        pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_AZUREGOS_SPIRIT_PLAYER1, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
        pPlayer->SEND_GOSSIP_MENU(200000, pCreature->GetGUID());
    }
    return true;
}
...
bool OnGossipSelect(Player* pPlayer, Creature* pCreature, uint32 uiSender, uint32 uiAction)
{
    ...
    if (pPlayer->GetQuestStatus(8555) == QUEST_STATUS_COMPLETE)
    {
        ...
        {
        case GOSSIP_ACTION_INFO_DEF + 1:
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_AZUREGOS_SPIRIT_PLAYER2, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
            pPlayer->SEND_GOSSIP_MENU(200001, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 2:
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_AZUREGOS_SPIRIT_PLAYER3, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);
            pPlayer->SEND_GOSSIP_MENU(200002, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 3:
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_AZUREGOS_SPIRIT_PLAYER4, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 4);
            pPlayer->SEND_GOSSIP_MENU(200003, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 4:
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_AZUREGOS_SPIRIT_PLAYER5, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 5);
            pPlayer->SEND_GOSSIP_MENU(200004, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 5:
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_AZUREGOS_SPIRIT_PLAYER6, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 6);
            pPlayer->SEND_GOSSIP_MENU(200005, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 6:
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_AZUREGOS_SPIRIT_PLAYER7, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 7);
            pPlayer->SEND_GOSSIP_MENU(200006, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 7:
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_AZUREGOS_SPIRIT_PLAYER8, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 8);
            pPlayer->SEND_GOSSIP_MENU(200007, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 8:
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_AZUREGOS_SPIRIT_PLAYER9, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 9);
            pPlayer->SEND_GOSSIP_MENU(200008, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 9:
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_AZUREGOS_SPIRIT_PLAYER10, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 10);
            pPlayer->SEND_GOSSIP_MENU(200009, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 10:
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_AZUREGOS_SPIRIT_PLAYER11, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 11);
            pPlayer->SEND_GOSSIP_MENU(200010, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 11:
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_AZUREGOS_SPIRIT_PLAYER12, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 12);
            pPlayer->SEND_GOSSIP_MENU(200011, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 12:
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_AZUREGOS_SPIRIT_PLAYER13, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 13);
            pPlayer->SEND_GOSSIP_MENU(200012, pCreature->GetGUID());
            msg = pPlayer->CanStoreNewItem(NULL_BAG, NULL_SLOT, dest, ITEM_MAGICAL_LEDGER, 1, false);
            if (msg == EQUIP_ERR_OK && !pPlayer->HasItemCount(ITEM_MAGICAL_LEDGER,true))
            {
              pPlayer->StoreNewItem(dest, ITEM_MAGICAL_LEDGER, 1, true);
            }
            break;
        case GOSSIP_ACTION_INFO_DEF + 13:
            pPlayer->CLOSE_GOSSIP_MENU();
            pCreature->MonsterYell("I SAID GOOD DAY!",1,pPlayer->GetGUID());
            break;
        }
