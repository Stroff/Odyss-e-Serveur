...
{
    { 786.6439f, 108.2498f, 153.6701f, 0 },
    { 806.8429f, 150.5902f, 153.6701f, 0 },
    { 759.1386f, 163.9654f, 153.6701f, 0 },
    { 744.3701f, 119.5211f, 153.6701f, 0 },
    { 710.0211f, 120.8152f, 153.6701f, 0 },
    { 706.6383f, 161.5266f, 153.6701f, 0 },
};
...
public:
    ...
    struct boss_anubarak_trialAI : public ScriptedAI
    {
        ...
        void JustDied(Unit* /*pKiller*/)
        {
            ...
            me->mySummonGameObject(191230, 802.05, 142.316, 142.165, 0, me);
        }
        ...
        void DamageTaken(Unit* /*pWho*/, uint32& uiDamage)
        {
            if (me->GetHealth() < uiDamage)
            {
                ...
                if (!m_bFall)
                {
                    ...
                    //At hit the ground
                    float z = me->GetMap()->GetHeight(me->GetPositionX(), me->GetPositionY(), 142.f);
                    sLog->outError("z = %f", z);
