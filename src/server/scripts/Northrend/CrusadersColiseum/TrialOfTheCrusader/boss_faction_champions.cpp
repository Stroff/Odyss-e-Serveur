...
public:
    ...
    struct mob_toc_druidAI : public boss_faction_championsAI
    {
        ...
        void Reset()
        {
            ...
            m_uiTranquilityTimer = 20*IN_MILLISECONDS;
        ...
        void UpdateAI(const uint32 uiDiff)
        {
            ...
            if (m_uiCommonTimer <= uiDiff)
            {
                ...
                m_uiCommonTimer = urand(6*IN_MILLISECONDS, 9*IN_MILLISECONDS);
...
public:
    ...
    struct mob_toc_paladinAI : public boss_faction_championsAI
    {
        ...
        void UpdateAI(const uint32 uiDiff)
        {
            ...
            /*
             * Activate again when this spell works
    ...
    struct mob_toc_priestAI : public boss_faction_championsAI
    {
        ...
        void UpdateAI(const uint32 uiDiff)
        {
            ...
            if (m_uiCommonTimer <= uiDiff)
            {
                if(Unit * pTarget = DoSelectLowestHpFriendly(40.0f)) {
                    switch (urand(0, 5))
                    {
                        ...
                        case 2: case 3:
                            ...
                            break;
                        case 4:
                            if (Unit *pTarget = urand(0, 1) ?  SelectTarget(SELECT_TARGET_RANDOM, 0, 0, true) : DoSelectLowestHpFriendly(40.0f))
                ...
                m_uiCommonTimer = urand(5*IN_MILLISECONDS, 7*IN_MILLISECONDS);
            } else m_uiCommonTimer -= uiDiff;
    ...
    struct mob_toc_warlockAI : public boss_faction_championsAI
    {
        ...
        void UpdateAI(const uint32 uiDiff)
        {
            ...
            case 0: case 1:
                ...
                m_uiCommonTimer = urand(7*IN_MILLISECONDS, 9*IN_MILLISECONDS);
            } else m_uiCommonTimer -= uiDiff;
            boss_faction_championsAI::UpdateAI(uiDiff);
        }
    };
...
public:
    ...
    struct mob_toc_mageAI : public boss_faction_championsAI
    {
        ...
        void Reset()
        {
            ...
            m_uiFrostNovaTimer = urand(10*IN_MILLISECONDS, 15*IN_MILLISECONDS);
        ...
        void UpdateAI(const uint32 uiDiff)
        {
            ...
            if (m_uiFrostNovaTimer <= uiDiff)
            {
                ...
                m_uiFrostNovaTimer = urand(25*IN_MILLISECONDS, 30*IN_MILLISECONDS);
...
public:
    ...
    struct mob_toc_warriorAI : public boss_faction_championsAI
    {
        ...
        void UpdateAI(const uint32 uiDiff)
        {
            ...
            /*
             * warrior gets hit by its own stun.
             * remove comment when spell is fixed 
