...
#define EMOTE_FEAR     "Auriaya ce prepare a incanter Hurlement terrifiant."
#define EMOTE_DEFENDER "Le Defenseur farouche vient d'apparaitre !"
        ...
        void UpdateAI(const uint32 diff)
        {
            ...
            while(uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_DEFENDER:
					...
					me->SummonCreature(34035, me->GetPositionX(), me->GetPositionY(), me->GetPositionZ());
...
public:
    ...
    struct mob_sanctum_sentryAI : public ScriptedAI
    {
        ...
        {
            if (pInstance)
                if (Creature *pAuriaya = me->GetCreature(*me, pInstance->GetData64(TYPE_AURIAYA)))
                    if (pAuriaya->AI())
