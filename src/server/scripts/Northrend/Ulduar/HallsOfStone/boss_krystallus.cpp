...
enum Spells
{
    ...
    SPELL_SHATTER                                  = 50810,
    SPELL_STONED                                   = 50812,                    //Spell is self cast by target
    H_SPELL_SHATTER                                = 61546,
    SPELL_STOMP                                    = 48131,
    H_SPELL_STOMP                                  = 59744,
    SPELL_MAGNETIC_PULL                               = 28337,
    SPELL_KNOCK_BACK                               = 10689,                    //Knockback spell until correct implementation is made
...
struct boss_krystallusAI : public ScriptedAI
{
    ...
    void SpellHitTarget(Unit* pTarget, const SpellEntry* pSpell)
    {
        ...
        if (pSpell->Id == SPELL_GROUND_SLAM)
        {
            ...
            {
                pTarget->CastSpell(pTarget, SPELL_KNOCK_BACK, true, NULL, NULL, me->GetGUID());
            }
        }
