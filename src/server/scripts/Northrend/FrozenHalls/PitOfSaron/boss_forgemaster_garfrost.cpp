...
#define SPELL_FORGE_MACE_HELPER RAID_MODE<uint32>(68785, 70335)
...
static const Position GorkunOrMartinPos = {697.8878f, -162.5657f, 527.4990f, 4.8907f};
        ...
        struct boss_garfrostAI : public BossAI
        {
            ...
            void JustDied(Unit* /*killer*/)
            {
                ...
                if (instance->GetData(DATA_TEAM_IN_INSTANCE) == ALLIANCE)
                    me->SummonCreature(NPC_MARTIN_VICTUS, GorkunOrMartinPos, TEMPSUMMON_CORPSE_DESPAWN);
                else
                    me->SummonCreature(NPC_GORKUN_IRONSKULL, GorkunOrMartinPos, TEMPSUMMON_CORPSE_DESPAWN);
