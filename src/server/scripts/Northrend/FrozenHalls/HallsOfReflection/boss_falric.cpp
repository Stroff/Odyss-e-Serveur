...
#define SPELL_HOPELESSNESS_RANK1 RAID_MODE(72395, 72390)
#define SPELL_HOPELESSNESS_RANK2 RAID_MODE(72396, 72391)
#define SPELL_HOPELESSNESS_RANK3 RAID_MODE(72397, 72393)
#define SPELL_DEFILING_HORROR    RAID_MODE(72435, 72452)
#define SPELL_QUIVERING_STRIKE   RAID_MODE(72422, 72453)
    ...
    struct boss_falricAI : public ScriptedAI
    {
       ...
       uint64 pSummon;
        ...
        void Reset()
        {
          ...
          if(m_pInstance->GetData(TYPE_FALRIC) != FAIL) {
              SummonCount = 0;
              m_bIsCall = false;
              m_failDone = false;
        ...
        void EnterCombat(Unit* pVictim)
        {
          ...
          DoCast(me, SPELL_HOPELESSNESS_RANK1);
        }

        void EnterEvadeMode() {
            m_pInstance->SetData(TYPE_FALRIC, FAIL);
        ...
        {
            if(!HealthAbovePct(33) && me->HasAura(SPELL_HOPELESSNESS_RANK2)) {
                me->RemoveAurasDueToSpell(SPELL_HOPELESSNESS_RANK2);
                DoCast(me, SPELL_HOPELESSNESS_RANK3);
            }
            else if(!HealthAbovePct(66) && me->HasAura(SPELL_HOPELESSNESS_RANK1)) {
                me->RemoveAurasDueToSpell(SPELL_HOPELESSNESS_RANK1);
                DoCast(me, SPELL_HOPELESSNESS_RANK2);
            }
        ...
        void UpdateAI(const uint32 uiDiff)
        {
            ...
            else if(m_pInstance->GetData(TYPE_FALRIC) == FAIL && !m_failDone) {
                SummonCount--;
                m_uiCheckSummon -= 4;
            ...
            {
                DoCast(me->getVictim(), SPELL_QUIVERING_STRIKE);
            ...
            if(m_uiGrowlTimer < uiDiff)
            {
                ...
                DoCast(me->getVictim(), SPELL_DEFILING_HORROR);
