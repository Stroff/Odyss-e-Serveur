...
class go_door_lever_broggok : public GameObjectScript
{
public:
    go_door_lever_broggok() : GameObjectScript("go_door_lever_broggok") { }
bool GOHello(Player* pPlayer, GameObject* pGo)
{
    ...
    if (GameObject *pDoor = pGo->FindNearestGameObject(181819, 100.0f))
        pDoor->SetGoState(GO_STATE_ACTIVE);

    if (GameObject *pDoor2 = pGo->FindNearestGameObject(181817, 100.0f))
        pDoor2->SetGoState(GO_STATE_ACTIVE);

    if (GameObject *pDoor3 = pGo->FindNearestGameObject(181820, 100.0f))
        pDoor3->SetGoState(GO_STATE_ACTIVE);

    if (GameObject *pDoor4 = pGo->FindNearestGameObject(181821, 100.0f))
        pDoor4->SetGoState(GO_STATE_ACTIVE);

    if (GameObject *pDoor5 = pGo->FindNearestGameObject(181818, 100.0f))
        pDoor5->SetGoState(GO_STATE_ACTIVE);
