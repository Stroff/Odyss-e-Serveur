...
#define GOSSIP_KRAKEN            "Je suis prêt(e) à défier le Kraken !"
...
public:
    ...
    case 35117:
        if (pPlayer->GetQuestStatus(14108) == QUEST_STATUS_INCOMPLETE)
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_KRAKEN,GOSSIP_SENDER_MAIN,GOSSIP_ACTION_INFO_DEF+99);
        break;
    ...
    case GOSSIP_ACTION_INFO_DEF + 99:
        pPlayer->CLOSE_GOSSIP_MENU();
        pPlayer->ActivateTaxiPathTo(1268);
        break;
        }
