...
void World::LoadConfigSettings(bool reload)
{
    ...
    m_bool_configs[CONFIG_RECUP_ENABLE] = sConfig->GetBoolDefault("Recup.Enable", true);
    SetRecupTable(sConfig->GetStringDefault("Recup.Table", "demandes_recups"));
    m_bool_configs[CONFIG_TWINKS_ENABLE] = sConfig->GetBoolDefault("Twinks.Enable", true);
