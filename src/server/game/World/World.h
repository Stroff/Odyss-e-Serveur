...
class World
{
    public:
        ...
        void SetRecupTable(const std::string& table) { m_recup_table = table; }

        const char* GetRecupTable() const { return m_recup_table.c_str(); }
