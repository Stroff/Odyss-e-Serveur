...
class Player : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        static void Customize(uint64 guid, uint8 gender, uint8 skin, uint8 face, uint8 hairStyle, uint8 hairColor, uint8 facialHair, bool change_gender = true);
		...
		uint32 GetAverageItemLevelOdyssee(uint32 uLevel) const;
