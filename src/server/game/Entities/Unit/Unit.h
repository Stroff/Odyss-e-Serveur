...
class Unit : public WorldObject
{
    public:
        ...
        uint32 DealMeleeDamage(CalcDamageInfo *damageInfo, bool durabilityLoss);
        ...
        // player or player's pet resilience (-1%)
        uint32 GetMeleeCritDamageReduction(uint32 damage) const { return GetCombatRatingDamageReduction(CR_CRIT_TAKEN_MELEE, 2.2f, 33.0f, damage, true); }
        uint32 GetRangedCritDamageReduction(uint32 damage) const { return GetCombatRatingDamageReduction(CR_CRIT_TAKEN_RANGED, 2.2f, 33.0f, damage, true); }
        uint32 GetSpellCritDamageReduction(uint32 damage) const { return GetCombatRatingDamageReduction(CR_CRIT_TAKEN_SPELL, 2.2f, 33.0f, damage, true); }

        // player or player's pet resilience (-1%), cap 100%
        uint32 GetMeleeDamageReduction(uint32 damage) const { return GetCombatRatingDamageReduction(CR_CRIT_TAKEN_MELEE, 2.0f, 100.0f, damage, false); }
        uint32 GetRangedDamageReduction(uint32 damage) const { return GetCombatRatingDamageReduction(CR_CRIT_TAKEN_RANGED, 2.0f, 100.0f, damage, false); }
        uint32 GetSpellDamageReduction(uint32 damage) const { return GetCombatRatingDamageReduction(CR_CRIT_TAKEN_SPELL, 2.0f, 100.0f, damage, false); }
		...
		void SendMonsterMoveTransportGormokk(Unit *vehicleOwner, uint32 VehicleId);
        ...
        int32 GetTotalAuraModifierByMiscValue(AuraType auratype, int32 misc_value, uint32 spellId = 0) const;
    ...
    private:
        ...
        uint32 GetCombatRatingDamageReduction(CombatRating cr, float rate, float cap, uint32 damage, bool crit) const;
