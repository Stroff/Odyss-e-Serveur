...
enum BattlegroundRVFireState
{
    BG_FIRE_STATE_CLOSE = 0,
    BG_FIRE_STATE_OPEN = 1
};

enum BattlegroundRVSpells 
{
    BG_RV_SPELL_FLAME_TRENCH = 42565
};
...
class BattlegroundRV : public Battleground
{
    ...
    protected:
        ...
        uint32 getFireState() { return FireState; };
        void setFireState(uint32 state) { FireState = state; };
};
#endif
