...
class AuraEffect
{
    ...
    public:
        ...
        // Hack Odyssee : AuraType GetAuraType() const { return (AuraType)m_spellProto->EffectApplyAuraName[m_effIndex]; }
		AuraType GetAuraType() const { return m_spellProto ? (AuraType)m_spellProto->EffectApplyAuraName[m_effIndex]:(AuraType)NULL; }
